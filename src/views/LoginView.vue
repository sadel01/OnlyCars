      ...
      <form class="form" @submit.prevent>
        ...
        <div class="container-1">
          <div class="group">
            ...
            <p v-if="errorMessage" class="error" style="font-size: 12px; color: red">
              {{ errorMessage }}
            </p>
            <p v-if="successMessage" class="success" style="font-size: 12px; color: green">
              {{ successMessage }}
            </p>
          </div>
        </div>
        ...
        <div class="sign-up">
          <span class="txt">¿No tienes cuenta? </span
          ><router-link to="/register" style="color: #fbc40e">Regístrate aquí</router-link>
        </div>
      </form>
    </div>
  </div>
